...
def train(train_dir, val_dir, model_dir, args):
    ...
    train_set = MaskDataset(train_dir)
    num_classes = 1
    val_set = MaskDataset(val_dir)
    ...
    for epoch in range(args.epochs):
        ...
        for idx, train_batch in enumerate(train_loader):
            ...
            matches += (abs(labels-outs) < 0.5).sum().item()
        ...
        with torch.no_grad():
            ...
            for val_batch in val_loader:
                ...
                acc_item = (abs(labels-outs) < 0.5).sum().item()
